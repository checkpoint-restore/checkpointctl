...
|Show changes between two container checkpoints
...
checkpointctl-build(1), checkpointctl-diff(1), checkpointctl-inspect(1),
checkpointctl-list(1), checkpointctl-memparse(1), checkpointctl-plugin(1),
checkpointctl-show(1)
